...
<html class="fixed">
	<head>
		...
		<title>Online Crime Reporting System | Approved  Case for Chargesheet</title>
			...
			<div class="inner-wrapper">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Approved Case for Chargesheet</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Approved Case for </span></li>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Approved Case for Chargesheet</h2>
							</header>
