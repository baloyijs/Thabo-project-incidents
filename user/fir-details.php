...
<html class="fixed">
	<head>
		<title>Online Crime Reporting  System | View Case Details</title>
...
Case Number: <?php  echo $row->FIRNo;?></td></tr>
 <tr>
...
{
  echo "Your Case has been approved";
}

if($row->Status=="Cancelled")
{
 echo "Your Case has been cancelled";
}
