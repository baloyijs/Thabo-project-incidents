...
$query->bindParam(':purpose',$purpose,PDO::PARAM_STR);
 ...
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Your Case Request Has Been Send to us. We Will Contact You Soon")</script>';
							...
							<form class="form-horizontal" method="post">
								...
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Case Form</h2>
...
<option value="<?php echo htmlentities($row->CategoryName);?>"><?php echo htmlentities($row->CategoryName);?></option>
 <?php } ?>
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Name of Accused </label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Nationality <span class="required">*</span></label>
											<div class="col-sm-9">
										...
										<div class="form-group">
											<label class="col-sm-3 control-label">Purpose of applying copy of Case<span class="required">*</span></label>
											<div class="col-sm-9">
