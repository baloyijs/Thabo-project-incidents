...
<html class="fixed">
	<head>
		...
		<title>Online Crime Reporting  System |  Search Case</title>
					...
					<!-- start: page -->
						<section class="panel">
							<header class="panel-heading">
								...
								<h3>Search <span class="table-project-n">Case</span></h3>
								<form class="form-horizontal" method="post">
								<div class="form-group">
											<label class="col-sm-3 control-label">Search by Case Number <span class="required">*</span></label>
											<div class="col-sm-9">
												<input type="text" class="form-control" name="searchdata" value="" required='true' placeholder="Enter Case Number">
											</div>
										</div>
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>	
                                ...
                                <thead style="color: red;font-size: 16px">
                                    <tr>
                                        ...
                                        <th class="d-none d-sm-table-cell">Case Date</th>
