...
body {
  ...
  background-size: cover;
	...
	<body>
<a href="../index.php" class="logo pull-left"><h2 style="padding-top: 30px;padding-left: 30px;color: #fff"><i class="fa fa-home"></i></h2></a>
		<section class="body-sign">
			<div class="center-sign">
				<a href="signup.php" class="logo pull-left">
					<strong style="font-size: 20px; color :#fff">Online Crime reporting  System</strong>
				</a>
